...
function trigger_box($object){
    ...
    <p id="scroll-help" <?php if ($popup_trigger !== "scroll"){echo 'style="display:none;"';} ?>><small><strong>Lower percentage:</strong> bottom of the page </br><strong>Higher percentage:</strong> top of the page</small></p>
